...
interface HeroImageSliderSimpleProps {
  className?: string;
}

export default function HeroImageSliderSimple({ className = '' }: HeroImageSliderSimpleProps) {
  ...
  // Use the same hero image for all slides for now
  const slides = heroSlidesContent.map(slideContent => ({
    ...slideContent,
